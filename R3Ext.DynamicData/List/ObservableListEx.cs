...
using R3Ext.DynamicData.List.Internal;

namespace R3Ext.DynamicData.List;
...
public static partial class ObservableListEx
{
    ...
    public static Observable<R3Ext.DynamicData.List.IChangeSet<TResult>> Transform<T, TResult>(
