...
public static class AsyncExtensions
{
    ...
    /// </summary>
    public static Observable<TResult> SelectLatestAsync<TSource, TResult>(
    ...
    /// </summary>
    public static Observable<TResult> SelectAsyncSequential<TSource, TResult>(
        this Observable<TSource> source,
        Func<TSource, CancellationToken, ValueTask<TResult>> selector,
        bool configureAwait = true,
        bool cancelOnCompleted = true)
        ...
        bool cancelOnCompleted = true)
    {
        ...
        return source.SelectAwait<TSource, TResult>((x, ct) => new ValueTask<TResult>(selector(x)), AwaitOperation.Sequential, configureAwait,
            cancelOnCompleted);
    }
    ...
    /// </summary>
    public static Observable<TResult> SelectAsyncConcurrent<TSource, TResult>(
        this Observable<TSource> source,
        Func<TSource, CancellationToken, ValueTask<TResult>> selector,
        int maxConcurrency,
        bool configureAwait = true,
        ...
        bool cancelOnCompleted = true)
    {
        ...
        return source.SelectAwait<TSource, TResult>((x, ct) => new ValueTask<TResult>(selector(x)), AwaitOperation.Parallel, configureAwait, cancelOnCompleted,
            maxConcurrency);
    }
