// Port of DynamicData Node to R3.
...
/// <summary>
/// Node describing the relationship between an item and its ancestors and descendants.
/// </summary>
    ...
    where TKey : notnull
{
    ...
    internal void Update(Action<ICacheUpdater<Node<TObject, TKey>, TKey>> updateAction) => _children.Edit(updateAction);
