...
public class SampleViewModel : ObservableObject
{
    ...
    public sealed class DeepD : ObservableObject
    {
        ...
        public DeepLeaf Leaf { get => _leaf; set => SetProperty(ref _leaf, value); }
    }
    public sealed class DeepC : ObservableObject
    {
        private DeepD _d = new();
        public DeepD D { get => _d; set => SetProperty(ref _d, value); }
    }
    public sealed class DeepB : ObservableObject
    {
        private DeepC _c = new();
        public DeepC C { get => _c; set => SetProperty(ref _c, value); }
    }
    public sealed class DeepA : ObservableObject
    {
        private DeepB _b = new();
        public DeepB B { get => _b; set => SetProperty(ref _b, value); }
    }
    public sealed class DeepRoot : ObservableObject
    {
        private DeepA _a = new();
        public DeepA A { get => _a; set => SetProperty(ref _a, value); }
    }
    ...
    public sealed class MixedRoot : ObservableObject
    {
        ...
        public NonNotifyParent NonNotify { get => _nonNotify; set => SetProperty(ref _nonNotify, value); }
    }
    ...
    {
        get => _mixed;
        set => SetProperty(ref _mixed, value);
    }
